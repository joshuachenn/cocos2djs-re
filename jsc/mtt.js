...
var u = f[a].resolve(), l = e._fieldsArray.indexOf(u), p = u.resolvedType instanceof n ? "int32" : u.type, c = i.basic[p];
...
if (u.packed && i.packed[p] !== undefined) r("w.uint32(%i).fork()", (u.id << 3 | 2) >>> 0)("for(var i=0;i<%s.length;++i)", t)("w.%s(%s[i])", p, t)("w.ldelim()"); else {
r("for(var i=0;i<%s.length;++i)", t);
c === undefined ? s(r, u, l, t + "[i]") : r("w.uint32(%i).%s(%s[i])", (u.id << 3 | c) >>> 0, p, t);
}
r("}");
} else {
u.optional && r("if(%s!=null&&m.hasOwnProperty(%j))", t, u.name);
c === undefined ? s(r, u, l, t) : r("w.uint32(%i).%s(%s)", (u.id << 3 | c) >>> 0, p, t);
}
}
return r("return w");
};
...
var n = e(34), i = e(29), o = e(35), s = e(16), f = e(20), a = e(25), u = e(15), l = e(33), p = e(22), c = e(36), h = e(37), d = /^[1-9][0-9]*$/, y = /^-?[1-9][0-9]*$/, m = /^0[x][0-9a-fA-F]+$/, v = /^-?0[x][0-9a-fA-F]+$/, g = /^0[0-7]+$/, b = /^-?0[0-7]+$/, w = /^(?![eE])[0-9]*(?:\.[0-9]*)?(?:[eE][+-]?[0-9]+)?$/, O = /^[a-zA-Z_][a-zA-Z_0-9]*$/, k = /^(?:\.?[a-zA-Z_][a-zA-Z_0-9]*)(?:\.[a-zA-Z_][a-zA-Z_0-9]*)*$/, j = /^(?:\.[a-zA-Z_][a-zA-Z_0-9]*)+$/;
function A(e, t, r) {
if (!(t instanceof i)) {
r = t;
t = new i();
...
e.add(o);
J || !o.repeated || c.packed[n] === undefined && c.basic[n] !== undefined || o.setOption("packed", !1, !0);
} else Y(e, t);
}
function Y(e, t) {
var r = B();
...
D("<");
var t = B();
if (c.mapKey[t] === undefined) throw C(t, "type");
D(",");
var r = B();
...
o.filename = e;
var n, s = o(t, i, r), u = 0;
if (s.imports) for (;u < s.imports.length; ++u) (n = i.resolvePath(e, s.imports[u])) && p(n);
if (s.weakImports) for (u = 0; u < s.weakImports.length; ++u) (n = i.resolvePath(e, s.weakImports[u])) && p(n, !0);
...
var h = 0;
l.isString(t) && (t = [ t ]);
for (var d, y = 0; y < t.length; ++y) (d = i.resolvePath("", t[y])) && p(d);
if (f) return i;
h || a(null, i);
return undefined;
};
...
var i = e(15), o = e(25), s = e(16), f = e(20), a = e(33), u = e(21), l = e(27), p = e(42), c = e(37), h = e(14), d = e(13), y = e(40), m = e(12), v = e(41);
function g(e, t) {
n.call(this, e, t);
this.fields = {};
...
var p = t.nested[u[l]];
r.add((p.id !== undefined ? s.fromJSON : p.fields !== undefined ? g.fromJSON : p.values !== undefined ? i.fromJSON : p.methods !== undefined ? a.fromJSON : n.fromJSON)(u[l], p));
}
